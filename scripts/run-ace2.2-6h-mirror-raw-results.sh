...
# Mirror the ACE2.2-ERA5 (6-hourly) raw AIMIP inference results from weka to GCS so that
...
cat > "$SPEC" <<EOF
version: v2
description: Mirror ACE2.2-ERA5 (6-hourly) raw AIMIP inference results weka -> GCS
