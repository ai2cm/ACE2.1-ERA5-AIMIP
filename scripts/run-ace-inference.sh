...
AIMIP_INFERENCE_BASE_CONFIG_PATH=$REPO_ROOT/configs/$AIMIP_INFERENCE_CONFIG_FILENAME
AIMIP_INFERENCE_P2K_CONFIG_FILENAME="ace-aimip-inference-p2k-config.yaml"
AIMIP_INFERENCE_BASE_P2K_CONFIG_PATH=$REPO_ROOT/configs/$AIMIP_INFERENCE_P2K_CONFIG_FILENAME
AIMIP_INFERENCE_P4K_CONFIG_FILENAME="ace-aimip-inference-p4k-config.yaml"
AIMIP_INFERENCE_BASE_P4K_CONFIG_PATH=$REPO_ROOT/configs/$AIMIP_INFERENCE_P4K_CONFIG_FILENAME
