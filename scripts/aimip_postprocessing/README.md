...
The `ace-aimip` conda environment (see `environment.yml` at the repo root) has all required dependencies. No additional installation is needed.
...
python postprocess.py \
    --raw-results-dir gs://my-bucket/inference-results \
...
Override output version and destination:
